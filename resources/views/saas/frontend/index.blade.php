                                                    ...
                                                    <div
                                                        ...
                                                        <ul class="pricing-features set-auto-height">
                                                            ...
                                                            <li class="d-flex align-items-center mb-3">
                                                                ...
                                                                <span>
                                                                    {{ $package->max_property == -1 ? __('Add Unlimited Properties') : __('Add ' . $package->max_property . ' Properties') }}</span>
                                                            </li>
                                                            <li class="d-flex align-items-center mb-3">
                                                                <span
                                                                    class="price-check-icon flex-shrink-0 d-inline-flex align-items-center justify-content-center status-btn-blue radius-50 me-2">
                                                                ...
                                                                <span>
                                                                    {{ $package->max_unit == -1 ? __('Add Unlimited Units') : __('Add ' . $package->max_unit . ' Units') }}</span>
                                                            </li>
                                                            <li class="d-flex align-items-center mb-3">
                                                                <span
                                                                    class="price-check-icon flex-shrink-0 d-inline-flex align-items-center justify-content-center status-btn-blue radius-50 me-2">
                                                            ...
                                                            <li class="d-flex align-items-center mb-3">
                                                                ...
                                                                <span>
                                                                    {{ $package->max_invoice == -1 ? __('Add Unlimited Invoices') : __('Add ' . $package->max_invoice . ' Invoices') }}</span>
                                                            </li>
                                                            <li class="d-flex align-items-center mb-3">
                                                                <span
                                                                    class="price-check-icon flex-shrink-0 d-inline-flex align-items-center justify-content-center status-btn-blue radius-50 me-2">
                                                        ...
                                                        <button type="submit" class="theme-btn-outline mt-1"
